...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'username', 'first_name', 'last_name', 'profile','is_staff']
...
class RecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Record
        fields = ['id', 'date', 'timeStart', 'timeFinish', 'master', 'guest', 'procedure','filial','is_complete']
        # fields = "__all__"


class RecordLiteSerializer(serializers.ModelSerializer):
    class Meta:
        model = Record
        fields = "__all__"
