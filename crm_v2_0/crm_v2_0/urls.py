...
urlpatterns = [
    ...
    path('api/filial/<int:id>', FilialDetailAPIView.as_view()),
    path('api/schedule', ScheduleAPIView.as_view()),
    path('api/schedule/create', ScheduleCreateAPIView.as_view()),
    path('api/schedule/delete/<int:id>', ScheduleDeleteAPIView.as_view()),
    path('api/schedule/<int:id>', ScheduleDetailAPIView.as_view()),
    path('api/user', UserAPIView.as_view()),
    path('api/user/<int:id>', UserDetailAPIView.as_view()),
    path('api/procedure', ProcedureAPIView.as_view()),
    path('api/procedure/<int:id>', ProcedureDetailAPIView.as_view()),
