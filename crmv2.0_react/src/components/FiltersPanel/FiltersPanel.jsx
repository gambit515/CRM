...
const FiltersPanel = ({updateTable, downloadScheduleTable}) => {
    ...
    return (
        <div className={"filters"}>
            <label className={"mainLabel"}>Опции</label>
            ...
            <div className={"buttonsRow"}>
                ...
                <button onClick={downloadScheduleExcel} className={"buttonxls"}>Экспорт в xls</button>
                */}
                <button className={"buttonSearch"} onClick={openModal}>Добавить запись</button>
            </div>
        </div>
    );
};
